...
\section{Order of Operations} % Credit: Princeton University CS
...
\begin{center}\begin{tabularx}{\textwidth}{clccX}\toprule
  ...
  \multirow{6}{*}{14} & U. Plus           & \lstinline|+x|    & \multirow{6}{*}{\(\leftarrow\)} & Returns the value of \lstinline|int x|\\
                  ...
                  10  & Bitshift          & \parbox[c]{1.5cm}{\centering\lstinline|x >> y|\\\lstinline|x << y|\\\lstinline|x >>> y|} & \(\rightarrow\) & \\\midrule
