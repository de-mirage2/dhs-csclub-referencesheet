...
\begin{center}\begin{tabularx}{\textwidth}{lX}\toprule
  ...
  \multirow{5}{*}{\lstinline|ArrayList|} & \lstinline|ArrayList<Type> x = new ArrayList<Type>();| \\
                                         ...
                                         & \lstinline|x.clear()| \\
                                         & \lstinline|boolean x.isEmpty()| \\\midrule
  \multirow{4}{*}{\lstinline|HashMap|}   & \lstinline|HashMap<KeyType, ValueType> x = new HashMap<>();| \\
                                         & \lstinline|x.put(KeyType k, ValueType v)| \\
                                         & \lstinline|x.get(KeyType k)| \\
                                         & \lstinline|x.remove(KeyType k)| \\
\end{tabularx}\end{center}
